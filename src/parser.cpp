...
#line 2864 "src/parser.cpp"
    break;

  case 103: /* MaybeFuncFParams: FuncFParams  */
#line 920 "src/parser.y"
                  { (yyval.stmttype) = (yyvsp[0].stmttype); }
#line 2870 "src/parser.cpp"
    break;
